...
<?php
    ...
    <form action="controlador.php" method="post" onsubmit="return vacios()" >
        <div class="container">
			...
			<p>
                <h2>Realizar Venta Materiales MENUDEO</h2>
			</p>
				...
				<input type="text" name="txtmaterial" id="txtmaterial" class="form-control" placeholder="Introduce Nombre" value = "<?php echo $arrAct['material']; ?>" /><br>
				...
				<input type="number" name="txtmenudeo" id="txtmenudeo" class="form-control" value = "<?php echo $arrAct['preciomenudeom']; ?>"/><br>
				...
				<input type="submit" value="Realizar Venta" id="btnVentaMaterialMenudeo" class="btn btn-success" name="btnVentaMaterialMenudeo"/>
			</div>
    </form>

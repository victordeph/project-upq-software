...
<?php
    ...
    <form action="controlador.php" method="post" onsubmit="return vacios()" >
        <div class="container">
			...
			<p>
                <h2>Realizar Venta Producto MENUDEO</h2>
			</p>
				...
				<input type="number" name="txtmenudeo" id="txtmenudeo" class="form-control" value = "<?php echo $arrAct['preciomenudeo']; ?>"/><br>
				...
				<input type="submit" value="Realizar Venta" id="btnVentaProductoMenudeo" class="btn btn-success" name="btnVentaProductoMenudeo"/>
			</div>
    </form>

...
<?php
    ...
    <form action="controlador.php" method="post" onsubmit="return vacios()" >
        <div class="container">
			...
			<p>
                <h2>Realizar Venta Materiales Mayoreo</h2>
			</p>
				...
				<input type="text" name="txtmaterial" id="txtmaterial" class="form-control"  value = "<?php echo $arrAct['material']; ?>" /><br>
				<label>Cantidad: </label>
				<input type="number" name="txtcantidad" id="txtcantidad" class="form-control" placeholder="Introduce Cantidad" /><br>
				<label>Precio Mayoreo: </label>
				<input type="number" name="txtmayoreo" id="txtmayoreo" class="form-control" value = "<?php echo $arrAct['preciomayoreom']; ?>"/><br>
				...
				<input type="submit" value="Realizar Venta" id="btnVentaMaterialMayoreo" class="btn btn-success" name="btnVentaMaterialMayoreo"/>
			</div>
    </form>
